        ...
        <div class="dash-content">
            ...
            <aside class="dashboard-content">
                <div class="header">
                    ...
                    <p>École Gesacadem - Statistiques financières</p>
                </div>

                <div class="actions">
                    <a href="{{ route('statistiques.detaillees') }}" class="btn btn-primary">
                        Statistiques Détaillées
                    </a>
                    <a href="{{ route('statistiques.export.pdf') }}" class="btn btn-success">
                        Exporter en PDF
                    </a>
                </div>
